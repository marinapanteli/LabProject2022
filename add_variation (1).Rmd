...
rngs # ranges of all 95 bam alignment reads
...
z # For the 5 variations (so many of the 50 are of transcript of interest), see the alternative alleles of the align. reads that overlap in the location of them all (all 5) 
# SEE THE SAPPLY ABOVE 
  
# table(ss)
getSeq(Hsapiens, variation_regs[nm]) # Also visible before the '/' of the nm string. It is the original nucleotides


table(apply(z, 1, paste, collapse="__")) # The different combinations that are generated by the different reads
